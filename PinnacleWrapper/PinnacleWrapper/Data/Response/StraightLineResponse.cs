...
{
    public class StraightLineResponse
    {
        [JsonProperty(PropertyName = "status")]
        public StraightLineResponseStatus Status;        // if the value is NOT_EXISTS, then this will be the only parameter in the response. All other params would be empty.
